...
\item \begin{minipage}[t]{\linewidth}
          ...
          \medskip
          Enregistrez votre fichier avec \commande{Fichier > Enregistrer sous...}, ou \commande{Ctrl + S}. Donnez un nom à votre programme (sans espace débutant par une majuscule) et sélectionner \commande{Java} comme type de fichier. Cliquez sur \commande{Enregister}.
       \end{minipage}
