...
Un des ces gyros est l'\texttt{ADIS16448\_IMU}\footnote{En réalité, ce capteur est bien plus qu'un gyro : c'est un IMU (\textit{Inertial Measurement Unit}). Voir \ref{adis16448}.}. Cette classe n'est pas incluse dans WPILib : elle peut être \href{https://github.com/juchong/ADIS16448-RoboRIO-Driver/blob/master/Java/src/main/java/com/analog/adis16448/frc/ADIS16448_IMU.java}{télécharger ici}.
...
public class LigneDroiteGyro extends TimedRobot {
	...
	private static final double K_ANGLE = -0.03; 
...
\subsection{ADIS16448\_IMU}\label{adis16448}
